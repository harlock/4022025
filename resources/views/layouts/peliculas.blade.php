        ...
        <div class="row min-vh-100">
            <div class="col-2 d-flex flex-column align-items-center bg-dark text-white p-3">
                ...
                <ul class="nav flex-column w-100 mt-3">
                    ...
                    <li class="nav-item py-2 {{ Request::is('director*') ? 'bg-primary rounded' : '' }}"><a href="{{ route('directores.index') }}" class="text-decoration-none fw-bold text-white align-items-center gap-4 d-flex"><i class="fa-solid fa-cloud ms-4"></i>Directores</a></li>
